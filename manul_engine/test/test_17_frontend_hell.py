...
TESTS = [
    ...
    {"n": "4", "step": "Fill 'Delivery Address' with 'Kyiv'", "m": "input", "st": ["Delivery Address"], "tf": "delivery address", "exp": "t4"},
    {"n": "5", "step": "Click 'Proceed'", "m": "clickable", "st": ["Proceed"], "tf": None, "exp": "t5"},
    {"n": "6", "step": "Fill 'Promo Code' with 'MANUL'", "m": "input", "st": ["Promo Code"], "tf": "promo code", "exp": "t6"},
    {"n": "7", "step": "Fill 'Credit Card Number' with '1234'", "m": "input", "st": ["Credit Card Number"], "tf": "credit card number", "exp": "t7"},
    ...
    {"n": "11", "step": "Click 'Download Invoice'", "m": "clickable", "st": ["Download Invoice"], "tf": None, "exp": "t11"},
    {"n": "12", "step": "Fill 'First Name' with 'Alex'", "m": "input", "st": ["First Name"], "tf": "first name", "exp": "t12"},
    ...
    {"n": "18", "step": "Fill 'Date of Birth' with '2000-01-01'", "m": "input", "st": ["Date of Birth"], "tf": "date of birth", "exp": "t18"},
    {"n": "19", "step": "Fill 'Biography' with 'QA'", "m": "input", "st": ["Biography"], "tf": "biography", "exp": "t19"},
    ...
    {"n": "22", "step": "Fill 'security_pin' with '0000'", "m": "input", "st": ["security_pin"], "tf": "security pin", "exp": "t22"},
    ...
    {"n": "26", "step": "Fill 'Secret Token' with 'XYZ'", "m": "input", "st": ["Secret Token"], "tf": "secret token", "exp": "t26"},
    ...
    {"n": "29", "step": "Fill 'Phone Number' with '555'", "m": "input", "st": ["Phone Number"], "tf": "phone number", "exp": "t29"},
