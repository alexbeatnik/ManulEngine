...
TESTS = [
    ...
    {"n": "1. data-qa exact beats text match",
     ...
     "m": "clickable", "st": ["Confirm Order"], "tf": None,
     "exp": "dqa_exact",
    ...
    {"n": "3. Aria-label input",
     ...
     "m": "input", "st": ["Billing Address"], "tf": "billing address",
     "exp": "aria_input",
    ...
    {"n": "5. html_id aligns with target_field",
     ...
     "m": "input", "st": ["Shipping Address"], "tf": "shipping address",
    ...
    {"n": "6. Enabled beats disabled (×0.0 penalty)",
     ...
     "m": "clickable", "st": ["Place Order"], "tf": None,
     "exp": "enabled_btn",
    ...
    {"n": "8. Checkbox mode resolves real checkbox",
     ...
     "m": "clickable", "st": ["Newsletter"], "tf": None,
     "exp": "chk_real",
    ...
    {"n": "9. Input field wins over button in input mode",
     ...
     "m": "input", "st": ["Search Query"], "tf": "search query",
     "exp": "input_field",
    ...
    {"n": "11. data-testid acts as data-qa",
     ...
     "m": "clickable", "st": ["Checkout Submit"], "tf": None,
     "exp": "testid_btn",
    ...
    {"n": "13. name_attr exact match",
     ...
     "m": "input", "st": ["security_pin"], "tf": "security pin",
     "exp": "name_attr_input",
    ...
    {"n": "14. Dev-name context words boost",
     ...
     "m": "clickable", "st": ["Finalize Payment"], "tf": None,
     "exp": "ctx_dev",
    ...
    {"n": "15. Stacked signals (data-qa + placeholder + aria)",
     ...
     "m": "input", "st": ["Promo Code"], "tf": "promo code",
     "exp": "stacked_all",
...
def _test_weights_dict():
    ...
    _assert(WEIGHTS["cache"] > WEIGHTS["semantics"] > WEIGHTS["text"],
            "cache > semantics > text priority",
            f"{WEIGHTS['cache']} > {WEIGHTS['semantics']} > {WEIGHTS['text']}")
    _assert(WEIGHTS["text"] > WEIGHTS["attributes"],
            "text > attributes priority",
            f"{WEIGHTS['text']} > {WEIGHTS['attributes']}")
    _assert(WEIGHTS["attributes"] > WEIGHTS["proximity"],
...
def _test_scorer_data_qa_dominance():
    ...
    el_dqa = {
        "name": "Proceed button", "xpath": "/btn[1]", "is_select": False,
        "is_shadow": False, "is_contenteditable": False, "class_name": "",
        "tag_name": "button", "input_type": "", "data_qa": "confirm-order",
        "html_id": "dqa_exact", "icon_classes": "", "aria_label": "",
        "placeholder": "", "role": "", "disabled": False, "aria_disabled": "",
        "name_attr": "", "id": 1,
    }
    el_text = {
        "name": "Confirm Order button", "xpath": "/btn[2]", "is_select": False,
        "is_shadow": False, "is_contenteditable": False, "class_name": "",
        "tag_name": "button", "input_type": "", "data_qa": "",
        "html_id": "text_match", "icon_classes": "", "aria_label": "",
        "placeholder": "", "role": "", "disabled": False, "aria_disabled": "",
        "name_attr": "", "id": 2,
    }
    ...
    _assert(dqa_score > txt_score,
            "data-qa exact score > text match score",
            f"dqa={dqa_score} vs txt={txt_score}")
    _assert(dqa_score > 10_000,
            "data-qa exact crosses 10k threshold",
            f"score={dqa_score}")
...
def _test_disabled_penalty():
    ...
    el_ok = {
        "name": "Submit button", "xpath": "/btn[1]", "is_select": False,
        "is_shadow": False, "is_contenteditable": False, "class_name": "",
        "tag_name": "button", "input_type": "", "data_qa": "",
        "html_id": "ok_btn", "icon_classes": "", "aria_label": "",
        "placeholder": "", "role": "", "disabled": False, "aria_disabled": "",
        "name_attr": "", "id": 1,
    }
...
def _test_hidden_penalty():
    ...
    el_vis = {
        "name": "Save button", "xpath": "/btn[1]", "is_select": False,
        "is_shadow": False, "is_contenteditable": False, "class_name": "",
        "tag_name": "button", "input_type": "", "data_qa": "",
        "html_id": "vis_btn", "icon_classes": "", "aria_label": "",
        "placeholder": "", "role": "", "disabled": False, "aria_disabled": "",
        "name_attr": "", "id": 1,
    }
