...
TESTS = [
    # Global Topbar
    {"n": "1", "step": "Fill 'Search leads' with 'Acme'", "m": "input", "st": ["Search leads"], "tf": "search leads", "exp": "c1"},
    ...
    # Kanban Board
    {"n": "11", "step": "EXTRACT text of 'Acme Corp Deal' into {deal}", "ex": True, "var": "deal", "val": "Acme Corp Deal"},
    {"n": "12", "step": "Click 'Move to Contacted'", "m": "clickable", "st": ["Move to Contacted"], "tf": None, "exp": "c12"},
    {"n": "13", "step": "Click 'Move to Closed Won'", "m": "clickable", "st": ["Move to Closed Won"], "tf": None, "exp": "c13"},
    {"n": "14", "step": "Click 'Move to Closed Lost'", "m": "clickable", "st": ["Move to Closed Lost"], "tf": None, "exp": "c14"},
    {"n": "15", "step": "Click 'Add Column'", "m": "clickable", "st": ["Add Column"], "tf": None, "exp": "c15"},
    {"n": "16", "step": "Fill 'Column Name' with 'On Hold'", "m": "input", "st": ["Column Name"], "tf": "column name", "exp": "c16"},
    ...
    {"n": "19", "step": "Select 'List' from 'Board View'", "m": "select", "st": ["List", "Board View"], "tf": None, "exp": "c19"},
    {"n": "20", "step": "Click 'Export Board'", "m": "clickable", "st": ["Export Board"], "tf": None, "exp": "c20"},

    # Lead Creation Form
    {"n": "21", "step": "Fill 'Lead Name' with 'Elon Musk'", "m": "input", "st": ["Lead Name"], "tf": "lead name", "exp": "c21"},
    {"n": "22", "step": "Fill 'Company Name' with 'SpaceX'", "m": "input", "st": ["Company Name"], "tf": "company name", "exp": "c22"},
    {"n": "23", "step": "Fill 'Contact Email' with 'elon@x.com'", "m": "input", "st": ["Contact Email"], "tf": "contact email", "exp": "c23"},
    {"n": "24", "step": "Fill 'Phone Number' with '12345'", "m": "input", "st": ["Phone Number"], "tf": "phone number", "exp": "c24"},
    {"n": "25", "step": "Select 'Inbound' from 'Lead Source'", "m": "select", "st": ["Inbound", "Lead Source"], "tf": None, "exp": "c25"},
    {"n": "26", "step": "Fill 'Expected Revenue' with '1000000'", "m": "input", "st": ["Expected Revenue"], "tf": "expected revenue", "exp": "c26"},
    {"n": "27", "step": "Fill 'Estimated Close Date' with '2026-12-31'", "m": "input", "st": ["Estimated Close Date"], "tf": "estimated close date", "exp": "c27"},
    {"n": "28", "step": "Select 'Alex Dev' from 'Assignee'", "m": "select", "st": ["Alex Dev", "Assignee"], "tf": None, "exp": "c28"},
    ...
    {"n": "34", "step": "Click 'Schedule Meeting'", "m": "clickable", "st": ["Schedule Meeting"], "tf": None, "exp": "c34"},
    {"n": "35", "step": "Click 'Create Task'", "m": "clickable", "st": ["Create Task"], "tf": None, "exp": "c35"},
    {"n": "36", "step": "Fill 'Write your note' with 'Client called'", "m": "input", "st": ["Write your note"], "tf": "write your note", "exp": "c36"},
    ...
    # Details & Inline Edit
    {"n": "41", "step": "Fill 'Ticket Title' with 'Server FIXED'", "m": "input", "st": ["Ticket Title"], "tf": "ticket title", "exp": "c41"},
    {"n": "42", "step": "Select 'Resolved' from 'Status'", "m": "select", "st": ["Resolved", "Status"], "tf": None, "exp": "c42"},
    {"n": "43", "step": "Select 'Critical' from 'Priority'", "m": "select", "st": ["Critical", "Priority"], "tf": None, "exp": "c43"},
    {"n": "44", "step": "Click 'Remove Bug tag'", "m": "clickable", "st": ["Remove Bug tag"], "tf": None, "exp": "c44"},
    {"n": "45", "step": "Fill 'Add tag...' with 'Urgent'", "m": "input", "st": ["Add tag..."], "tf": "add tag...", "exp": "c45"},
    ...
    {"n": "56", "step": "Click 'Reject Candidate'", "m": "clickable", "st": ["Reject Candidate"], "tf": None, "exp": "c56"},
    {"n": "57", "step": "Select 'Not a fit' from 'Rejection Reason'", "m": "select", "st": ["Not a fit", "Rejection Reason"], "tf": None, "exp": "c57"},
    {"n": "58", "step": "Click 'Send Rejection Email'", "m": "clickable", "st": ["Send Rejection Email"], "tf": None, "exp": "c58"},
    {"n": "59", "step": "Click 'Schedule Interview'", "m": "clickable", "st": ["Schedule Interview"], "tf": None, "exp": "c59"},
    {"n": "60", "step": "Click 'Request Feedback'", "m": "clickable", "st": ["Request Feedback"], "tf": None, "exp": "c60"},

    # Bulk Actions
    {"n": "61", "step": "Check 'Select All Leads'", "m": "clickable", "st": ["Select All Leads"], "tf": None, "exp": "c61"},
    ...
    {"n": "67", "step": "Click 'Merge Duplicates'", "m": "clickable", "st": ["Merge Duplicates"], "tf": None, "exp": "c67"},
    {"n": "68", "step": "Click 'Add to Campaign'", "m": "clickable", "st": ["Add to Campaign"], "tf": None, "exp": "c68"},
    {"n": "69", "step": "Click 'Change Status'", "m": "clickable", "st": ["Change Status"], "tf": None, "exp": "c69"},
    {"n": "70", "step": "VERIFY 'Apply Bulk Action' is disabled", "ver": True, "step": "VERIFY that 'Apply Bulk Action' is disabled", "res": True},

    # Advanced Filters
    {"n": "71", "step": "Select 'Status' from 'Filter Field'", "m": "select", "st": ["Status", "Filter Field"], "tf": None, "exp": "c71"},
    {"n": "72", "step": "Select 'Equals' from 'Filter Operator'", "m": "select", "st": ["Equals", "Filter Operator"], "tf": None, "exp": "c72"},
    {"n": "73", "step": "Fill 'Filter Value' with 'Open'", "m": "input", "st": ["Filter Value"], "tf": "filter value", "exp": "c73"},
    ...
    {"n": "77", "step": "Fill 'Save filter as' with 'Active'", "m": "input", "st": ["Save filter as"], "tf": "save filter as", "exp": "c77"},
    {"n": "78", "step": "Click 'Save Filter'", "m": "clickable", "st": ["Save Filter"], "tf": None, "exp": "c78"},
    {"n": "79", "step": "Select 'My Open Leads' from 'Saved Filters'", "m": "select", "st": ["My Open Leads", "Saved Filters"], "tf": None, "exp": "c79"},
    {"n": "80", "step": "Click 'Clear All'", "m": "clickable", "st": ["Clear All"], "tf": None, "exp": "c80"},

    # Dashboards & Reporting
    {"n": "81", "step": "Select 'Time to Hire' from 'Report Type'", "m": "select", "st": ["Time to Hire", "Report Type"], "tf": None, "exp": "c81"},
    ...
    {"n": "89", "step": "Click 'Schedule Report'", "m": "clickable", "st": ["Schedule Report"], "tf": None, "exp": "c89"},
    {"n": "90", "step": "Click 'Include deleted records' switch", "m": "clickable", "st": ["Include deleted records"], "tf": None, "exp": "c90"},

    # Settings & Workflows
    {"n": "91", "step": "Click 'Create Workflow Rule'", "m": "clickable", "st": ["Create Workflow Rule"], "tf": None, "exp": "c91"},
    {"n": "92", "step": "Fill 'Rule Name' with 'Auto-assign'", "m": "input", "st": ["Rule Name"], "tf": "rule name", "exp": "c92"},
    {"n": "93", "step": "Select 'On Create' from 'Trigger Event'", "m": "select", "st": ["On Create", "Trigger Event"], "tf": None, "exp": "c93"},
    {"n": "94", "step": "Select 'Update Field' from 'Action'", "m": "select", "st": ["Update Field", "Action"], "tf": None, "exp": "c94"},
    {"n": "95", "step": "Click 'Save Workflow'", "m": "clickable", "st": ["Save Workflow"], "tf": None, "exp": "c95"},
    {"n": "96", "step": "Click 'Create Custom Field'", "m": "clickable", "st": ["Create Custom Field"], "tf": None, "exp": "c96"},
    {"n": "97", "step": "Fill 'Field Label' with 'Skype ID'", "m": "input", "st": ["Field Label"], "tf": "field label", "exp": "c97"},
    {"n": "98", "step": "Select 'Text' from 'Field Type'", "m": "select", "st": ["Text", "Field Type"], "tf": None, "exp": "c98"},
    {"n": "99", "step": "Click 'Save Field'", "m": "clickable", "st": ["Save Field"], "tf": None, "exp": "c99"},
    {"n": "100", "step": "Click 'Unlock Admin Mode' if exists", "m": "clickable", "st": ["Unlock Admin Mode"], "tf": None, "exp": None}, # Hidden
]
